	...
	<div class="row">
		<div class="col-md-12 mb-1">
			<div class="d-flex justify-content-end w-100">
				...
				<a href="./index.php?page=generate_report"><button class="btn btn-sm btn-success" style="display:none" id="print-btn"><i class="fa fa-file"></i>  Download Excel File</button></a>
			</div>
		</div>
	</div>
	<div class="row">
