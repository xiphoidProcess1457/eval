	...
	<div class="row">
		<div class="col-md-12 mb-1">
			<div class="d-flex justify-content-end w-100">
				...
				<button class="btn btn-sm btn-success" style="display:none" id="print-btn"><i class="fa fa-file"></i>  Print Results</button>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-9">
			...
			<table width="100%">
					<tr>
						...
						<td width="50%"><p><b>Academic Year: <span id="ay"><?php echo $_SESSION['academic']['year'].' '.(ordinal_suffix($_SESSION['academic']['semester'])) ?> Quarter</span></b></p></td>
					</tr>
					<tr>
